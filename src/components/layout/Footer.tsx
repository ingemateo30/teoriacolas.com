...
export default function Footer() {
  ...
  return (
    <footer className={`
      ...
      border-t border-gray-200 mt-auto transition-opacity duration-700
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="py-8 md:flex md:items-center md:justify-between">
          ...
          <div className="grid grid-cols-2 gap-8 md:gap-16">
            <div className="mt-4 md:mt-0">
              ...
              <ul className="space-y-2">
                <li>
                  <Link href="/learning/fundamentals" className="text-sm text-gray-600 hover:text-primary-600 transition-colors duration-200">
                    Fundamentos
                  </Link>
                </li>
                <li>
                  <Link href="/models" className="text-sm text-gray-600 hover:text-primary-600 transition-colors duration-200">
                    Modelos
                  </Link>
                </li>
                <li>
                  <Link href="/simulator" className="text-sm text-gray-600 hover:text-primary-600 transition-colors duration-200">
                    Simulador
                  </Link>
                </li>
              </ul>
            ...
            <div className="mt-4 md:mt-0">
              ...
              <ul className="space-y-2">
                <li>
                  <Link href="/about" className="text-sm text-gray-600 hover:text-primary-600 transition-colors duration-200">
                    Acerca de
                  </Link>
                </li>
                <li>
          ...
          <div className="mt-8 md:mt-0">
            <h2 className="text-sm font-semibold text-gray-700 tracking-wider uppercase mb-3 text-center md:text-right">
              Síguenos
            </h2>
            <div className="flex justify-center md:justify-end space-x-4">
              <a href="#" className="text-gray-400 hover:text-primary-600 transition-colors duration-200" aria-label="Twitter">
                <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M8.29 20.251c7.547 0 11.675-6.253 11.675-11.675 0-.178 0-.355-.012-.53A8.348 8.348 0 0022 5.92a8.19 8.19 0 01-2.357.646 4.118 4.118 0 001.804-2.27 8.224 8.224 0 01-2.605.996 4.107 4.107 0 00-6.993 3.743 11.65 11.65 0 01-8.457-4.287 4.106 4.106 0 001.27 5.477A4.072 4.072 0 012.8 9.713v.052a4.105 4.105 0 003.292 4.022 4.095 4.095 0 01-1.853.07 4.108 4.108 0 003.834 2.85A8.233 8.233 0 012 18.407a11.616 11.616 0 006.29 1.84" />
                </svg>
              </a>
              <a href="#" className="text-gray-400 hover:text-primary-600 transition-colors duration-200" aria-label="GitHub">
                <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a href="#" className="text-gray-400 hover:text-primary-600 transition-colors duration-200" aria-label="LinkedIn">
                <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="flex justify-center py-2">
          <div className="flex space-x-1">
            {[...Array(5)].map((_, i) => (
              <div 
                key={i} 
                className={`h-1 w-8 rounded-full bg-primary-${300 + i * 100}`}
                style={{
                  opacity: 0.6 + i * 0.1,
